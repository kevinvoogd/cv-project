...
The Repository also provides multiple [pre-trained models](https://github.com/kevinvoogd/cv-project/tree/main/models) which we trained ourselves from scratch. We have also provided all the losses file generates while training and testing.[Pkl](https://github.com/kevinvoogd/cv-project/tree/main/pkl_files)
